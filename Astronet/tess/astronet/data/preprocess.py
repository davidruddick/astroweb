...
from tess.light_curve_util import tess_io
from tess.light_curve_util import median_filter
from tess.light_curve_util import util
from tess.light_curve_util.median_filter import SparseLightCurveError
...
def read_and_process_light_curve(tic, tess_data_dir, injected=False, inject_dir='/pdo/users/yuliang',
                                 is_multi=False):
  ...
  file_names = tess_io.tess_filenames(tic, tess_data_dir, injected=injected, inject_dir=inject_dir)
  if not file_names:

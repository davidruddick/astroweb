...
from tess.astronet import models
from tess.astronet.data import preprocess
from tess.astronet.util import config_util
from tess.astronet.util import configdict
from tess.astronet.util import estimator_util
...
def _process_tce(feature_config):
  ...
  Raises:
    ...
    and 'local_view'.
  """
  if not {"global_view", "local_view", "secondary_view", "depth_change"}.issuperset(feature_config.keys()):
    raise ValueError(
